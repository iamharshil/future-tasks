		...
		<div>
			<div className="max-w-[280px] mx-auto">
				<div className="flex flex-col items-center mt-[10vh]">
					<h2 className="mb-5 text-slate-400 font-mono font-bold text-xl">Log In</h2>
					...
					<form>
						<input type="text" className="w-full px-6 py-3 mb-2 border border-slate-600 rounded-lg font-medium text-slate-950" placeholder="Username" />
						<input type="password" className="w-full px-6 py-3 mb-2 border border-slate-600 rounded-lg font-medium text-slate-950" placeholder="6 digit pin" />
